  ...
  <div class="col-xs-8 col-md-8 text-left">
      ...
      <div class="row">
        <div class="col-xs-6">
          ...
          <p class="text-white">The person that invited you to TCB sent you a password</p>
          </a>
        </div>
        <div class="col-xs-6">
          &nbsp;
      ...
      <div class="row">  
        <div class="col-xs-6">
          ...
          <p class="text-white"> No problem let's recover your password.</p>
          </a>
        </div>
        <div class="col-xs-6">
          &nbsp;
...
<br/><br/><br/><br/>
    ...
    <div class="text-gray"><small>
      (If you haven't received any invitation please contact a TCB member and ask for an invitation.)
      </small>
    </div>
